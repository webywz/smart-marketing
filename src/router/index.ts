      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              path: 'text-image-studio',
              name: 'TextImageStudio',
              component: () => import('@/views/material/TextImageStudio.vue'),
              meta: { title: '文生图配置生成' },
            },
            {
              path: 'image-generation',
              name: 'ImageToImageStudio',
              component: () => import('@/views/material/ImageToImageStudio.vue'),
              meta: { title: '图生图任务中心' },
            },
            {
              path: 'icon-generation',
              name: 'IconGenerationStudio',
              component: () => import('@/views/material/IconGenerationStudio.vue'),
              meta: { title: '图示生成中心' },
            },
          ],
        },
